...
public class ParseAdapterFavourites extends RecyclerView.Adapter<ParseAdapterFavourites.ViewHolder> {

    private List<Television> televisions;
    Activity activity;

    public ParseAdapterFavourites(List<Television> parseItems, Activity activity) {
    ...
    @NonNull
    @Override
    public ParseAdapterFavourites.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ParseAdapterFavourites.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(@NonNull View view) {
            super(view);
            imageView = view.findViewById(R.id.tvImgFav);
            textView = view.findViewById(R.id.tvNameFav);
